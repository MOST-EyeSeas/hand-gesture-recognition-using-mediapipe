...
class HandGestureRecognitionNode:
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("/usb_cam/image_color", Image, self.image_callback)


        # Publishers
        self.image_pub = rospy.Publisher("/hand_gesture/annotated_image", Image, queue_size=10)
        self.gesture_pub = rospy.Publisher("/hand_gesture/recognized_gesture", String, queue_size=10)
        ...
        # Load labels
        self.keypoint_classifier_labels = self.load_labels('/home/catkin_ws/src/hand-gesture-recognition-using-mediapipe/model/keypoint_classifier/keypoint_classifier_label.csv')
        self.point_history_classifier_labels = self.load_labels('/home/catkin_ws/src/hand-gesture-recognition-using-mediapipe/model/point_history_classifier/point_history_classifier_label.csv')
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks, results.multi_handedness):
                ...
                if hand_sign_id == 2:  # Point gesture
                    self.point_history.append(landmark_list[8])  # Append the landmark point of the index finger tip
                else:
                ...
                self.gesture_pub.publish(self.keypoint_classifier_labels[hand_sign_id])
